(function () {
    ...
    app.saveSelectedTimetables = function() {
        var selectedTimetables = JSON.stringify(app.selectedTimetable);
    ...
    app.selectedTimetables = localStorage.selectedTimetables;
      if (app.selectedTimetables) {
         ...
         */
        app.updateSchedules('metros/1/bastille/A', 'Bastille, Direction La Défense');
        app.selectedTimetables = [
    ...
    //Ini jlrodriguez F3. Service Worker
    ...
    //Fin jlrodriguez F3. Service Worker
})();
